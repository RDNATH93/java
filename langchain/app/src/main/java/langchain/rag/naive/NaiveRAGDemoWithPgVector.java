...
public class NaiveRAGDemoWithPgVector {
    ...
    private static Assistant createAssistant(String documentPath) {
        ...
        // In this example, we will use Gemini's gemini-2.5-flash, but you can choose any supported model.
